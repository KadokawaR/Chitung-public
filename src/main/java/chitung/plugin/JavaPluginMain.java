package chitung.plugin;


import chitung.plugin.administration.AdminCommandDispatcher;
...
import chitung.plugin.core.responder.ResponderCenter;
import chitung.plugin.core.responder.basic.Repeater;
import chitung.plugin.core.responder.help.NewHelp;
import chitung.plugin.core.responder.imageresponder.ImageResponder;
import chitung.plugin.core.responder.universalrespond.URManager;
import chitung.plugin.utils.Nudge;
import chitung.plugin.utils.ContactUtil;
import chitung.plugin.core.broadcast.BroadcastSystem;
import chitung.plugin.core.game.GameCenter;
import chitung.plugin.core.responder.ResponderManager;
import chitung.plugin.utils.GroupPolice;
...
public final class JavaPluginMain extends JavaPlugin {
    ...
    private JavaPluginMain() {
        super(new JvmPluginDescriptionBuilder("chitung-public", "0.1.0")
